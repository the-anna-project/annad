...
func (c *collection) CallByNameMethod(args ...interface{}) ([]interface{}, error) {
...
func (c *collection) GetNamesMethod(args ...interface{}) ([]interface{}, error) {
	if len(args) > 1 {
...
func (c *collection) GetNumMethod(args ...interface{}) ([]interface{}, error) {
	if len(args) > 0 {
