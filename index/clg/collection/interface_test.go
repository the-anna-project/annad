...
func Test_Interface_DiscardInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).DiscardInterface(testCase.Input...)
...
func Test_Interface_EqualInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).EqualInterface(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Interface_InsertArgInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).InsertArgInterface(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Interface_ReturnInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).ReturnInterface(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Interface_SwapInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SwapInterface(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Interface_TypeInterface(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).TypeInterface(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
