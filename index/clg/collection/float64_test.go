...
func Test_Float64_BetweenFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).BetweenFloat64(testCase.Input...)
...
func Test_Float64_DivideFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).DivideFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64_GreaterThanFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GreaterThanFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64_LesserThanFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).LesserThanFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64_MultiplyFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MultiplyFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64_SubtractFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SubtractFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64_SumFloat64(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SumFloat64(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
