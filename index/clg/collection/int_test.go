...
func Test_Int_BetweenInt(t *testing.T) {
	testCases := []struct {
		Input        []interface{}
		Expected     []interface{}
		...
		{
			Input:        []interface{}{1, 2, 4},
			Expected:     []interface{}{false},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{2, 2, 4},
			Expected:     []interface{}{true},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{3, 2, 4},
			Expected:     []interface{}{true},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{4, 2, 4},
			Expected:     []interface{}{true},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{5, 2, 4},
			Expected:     []interface{}{false},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{35, -13, 518},
			Expected:     []interface{}{true},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{-87, -413, -18},
			Expected:     []interface{}{true},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{-7, -413, -18},
			Expected:     []interface{}{false},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{-987, -413, -18},
			Expected:     []interface{}{false},
			ErrorMatcher: nil,
		},
		{
			Input:        []interface{}{3, 2, 4, "foo"},
			Expected:     nil,
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).BetweenInt(testCase.Input...)
...
func Test_Int_DivideInt(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).DivideInt(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Int_MultiplyInt(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MultiplyInt(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Int_SubtractInt(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SubtractInt(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Int_SumInt(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SumInt(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
