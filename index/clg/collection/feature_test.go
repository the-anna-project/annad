...
func Test_Feature_AddPositionFeature(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).AddPositionFeature(testCase.Input...)
...
func Test_Feature_GetCountFeature(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GetCountFeature(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Feature_GetDistributionFeature(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GetDistributionFeature(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Feature_NewFeatureSet(t *testing.T) {
	...
	for i, testCase := range testCases {
		// Test.
		output, err := testMaybeNewCollection(t).GetNewFeature(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		// Convert.
...
func Test_Feature_GetPositionsFeature(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GetPositionsFeature(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Feature_GetSequenceFeature(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GetSequenceFeature(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
