...
func (c *collection) AppendStringSlice(args ...interface{}) ([]interface{}, error) {
...
func (c *collection) ContainsStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) CountCharacterStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) CountStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) DifferenceStringSlice(args ...interface{}) ([]interface{}, error) {
...
func (c *collection) EqualMatcherStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) GlobMatcherStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) IndexStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) IntersectionStringSlice(args ...interface{}) ([]interface{}, error) {
	ss1, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) IsUniqueStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) JoinStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) NewStringSlice(args ...interface{}) ([]interface{}, error) {
	if len(args) > 0 {
...
func (c *collection) ReverseStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) StemStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) SortStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) SwapLeftStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) SwapRightStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) SymmetricDifferenceStringSlice(args ...interface{}) ([]interface{}, error) {
	ss1, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) UnionStringSlice(args ...interface{}) ([]interface{}, error) {
	ss1, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
...
func (c *collection) UniqueStringSlice(args ...interface{}) ([]interface{}, error) {
	ss, err := ArgToStringSlice(args, 0)
	if err != nil {
		return nil, maskAny(err)
	}
