...
func Test_Float64Slice_AppendFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).AppendFloat64Slice(testCase.Input...)
...
func Test_Float64Slice_ContainsFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).ContainsFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_CountFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).CountFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_DifferenceFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).DifferenceFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_EqualMatcherFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).EqualMatcherFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_GlobMatcherFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).GlobMatcherFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_IndexFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).IndexFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_IntersectionFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).IntersectionFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_IsUniqueFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).IsUniqueFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_MaxFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MaxFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_MeanFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MeanFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_MedianFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MedianFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_MinFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).MinFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_ModeFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).ModeFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_PercentilesFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).PercentilesFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_NewFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).NewFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_ReverseFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).ReverseFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_SortFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SortFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_SwapLeftFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SwapLeftFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_SwapRightFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SwapRightFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_SymmetricDifferenceFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).SymmetricDifferenceFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_UnionFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).UnionFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
...
func Test_Float64Slice_UniqueFloat64Slice(t *testing.T) {
	...
	for i, testCase := range testCases {
		output, err := testMaybeNewCollection(t).UniqueFloat64Slice(testCase.Input...)
		if (err != nil && testCase.ErrorMatcher == nil) || (testCase.ErrorMatcher != nil && !testCase.ErrorMatcher(err)) {
			t.Fatal("case", i+1, "expected", true, "got", false)
		}
		if testCase.ErrorMatcher == nil {
