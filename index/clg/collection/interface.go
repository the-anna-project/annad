...
func (c *collection) DiscardInterface(args ...interface{}) ([]interface{}, error) {
	return nil, nil
}

func (c *collection) EqualInterface(args ...interface{}) ([]interface{}, error) {
	if len(args) < 2 {
...
func (c *collection) InsertArgInterface(args ...interface{}) ([]interface{}, error) {
...
func (c *collection) ReturnInterface(args ...interface{}) ([]interface{}, error) {
	return args, nil
}

func (c *collection) SwapInterface(args ...interface{}) ([]interface{}, error) {
	if len(args) < 2 {
		return nil, maskAnyf(notEnoughArgumentsError, "expected 2 got %d", len(args))
	}
	if len(args) > 2 {
...
func (c *collection) TypeInterface(args ...interface{}) ([]interface{}, error) {
	if len(args) < 1 {
